function ripple() {
	var O = 'bootstrap',
		...
		_b = 'ripple.devmode.js',
		ac = '02DCC596A04FA47EFB502253CF339AE2',
		bc = '0A3533353BCEF4C835117E9490620631',
		cc = '34B094E3E7B4BEF7DB3ECD10CC3995A5',
		dc = '4B70A1BC1CC7C1FE4197132E2076AC08',
		ec = '8D78B028B002431E3A0F91D2DE5010D0',
		fc = ':',
		gc = '.cache.js',
		hc = 'link',
		ic = 'rel',
	...
	ripple.__sendStats = r;
	ripple.__moduleName = S;
	ripple.__errFn = null;
	ripple.__moduleBase = U;
	ripple.__softPermutationId = V;
	ripple.__computePropValue = null;
	ripple.__getPropMap = null;
	ripple.__installRunAsyncCode = function() {};
	ripple.__gwtStartLoadingFragment = function() {
		return null
	};
	ripple.__gwt_isKnownPropertyValue = function() {
		return false
	};
	ripple.__gwt_getMetaProperty = function() {
		return null
	};
	var s = null;
	...
	ripple.__moduleStartupDone = function(e) {
		var f = t[S].bindings;
		t[S].bindings = function() {
			var a = f ? f() : {};
			var b = e[ripple.__softPermutationId];
	...
	function A(k) {
		...
		ripple.onScriptDownloaded = function(a) {
			l(function() {
				m(a)
			})
		};
		...
		if (ripple.__errFn) {
			n.onerror = function() {
				ripple.__errFn(S, new Error(nb + code))
			}
		}
		p.getElementsByTagName(ob)[V].appendChild(n)
	}
	ripple.__startLoadingFragment = function(a) {
		return D(a)
	};
	ripple.__installRunAsyncCode = function(a) {
		var b = v();
		var c = b.body;
	...
	function F() {
		...
		ripple.__computePropValue = k;
		o.__gwt_activeModules[S].bindings = ripple.__getPropMap;
		r(O, $b);
		if (q()) {
			return D(_b)
		}
	...
	B();
	ripple.__moduleBase = C();
	t[S].moduleBase = ripple.__moduleBase;
	var H = F();
	if (o) {
